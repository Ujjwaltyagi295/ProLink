  ...
  if (isDesktop) {
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <button className="rounded-2xl w-full h-full hover:bg-neutral-100 cursor-pointer min-h-[240px] border p-4 md:p-6 flex flex-col items-center justify-center hover:shadow-md transition">
